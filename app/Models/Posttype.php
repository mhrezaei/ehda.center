...
class Posttype extends Model
{
    ...
    */
    ...
    /**
     * Returns all Folders of this Posttype in specified locale
     *
     * @param string $locale
     *
    ...
    {
        return $this->folders()->where('locale', $locale)->get();
    }

    /**
     * Returns all categories of this that belong to Folders in specified locale
     *
     * @param string $locale
     *
     * @return \Illuminate\Database\Eloquent\Collection
     */
    public function categoriesIn($locale)
    {
        $inLocaleFolders = $this->foldersIn($locale);
        $foldersIds = $inLocaleFolders->pluck('id')->toArray();

        return Category::whereIn('folder_id', $foldersIds)->get();
    }
