...
return [
    ...
    "form" => [
        ...
        'password_set_to_mobile'        => 'شماره‌ی تلفن همراه به عنوان گذرواژه در نظر گرفته شود.',
        ...
        'password_change_sms'           => "گذرواژه‌ی شما در سایت :site_title تغییر یافت: :new_password",
        ...
        'already_has_role'              => "نقش مورد نظر برای این کاربر وجود دارد.",
