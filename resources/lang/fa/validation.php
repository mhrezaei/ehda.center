...
return [
    ...
    */
    ...
    'javascript_validation' => [
        ...
        "password2"            => "تکرار گذرواژه را به درستی وارد نمایید.",
        ...
        "phone"                => 'تلفن ۱۱ رقمی خود را وارد نمایید.',
        ...
        "text"            => "متن را به درستی وارد نمایید.",

        'tracking_number' => 'کد پیگیری خود را وارد نمایید.',
    ],
    ...
    'attributes_placeholder' => [
        ...
        'tracking_number' => '(۱۰ رقم بدون خط تیره)',
    ],
