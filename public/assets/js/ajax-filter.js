    ...
    if (filterPanel.length) {
        ...
        if (typeof urlAttr !== typeof undefined) {
            ...
            filterPanel.find('.filter-slider').each(function (index) {
                ...
                if (modify) {
                    ...
                    sliderEl.slider({
                        ...
                        change: function (event, ui) {
                            minLabel.html(pd(nummber_format(ui.values[0])));
                            maxLabel.html(pd(nummber_format(ui.values[1])));
                ...
                minLabel.html(pd(nummber_format(values[0])));
                maxLabel.html(pd(nummber_format(values[1])));
            });
